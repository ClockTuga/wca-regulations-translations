...
Note-se que esta tradução não é uma versão oficial (embora seja disponibilizada no site da WCA): ela pode ser útil, mas não vem com nenhuma garantia. Se houver diferenças entre a tradução e a versão (atualmente oficial) em inglês, esta última deve ser usada.

### Regulamento e Orientações da WCA

O Regulamento da WCA contém o conjunto completo de Regras que se aplicam a todas as competições oficiais sancionadas pela World Cube Association.
Anteriormente, desde a versão de 1 de janeiro de 2013 até à versão de 1 de janeiro de 2025, o Regulamento da WCA estava dividido em Regulamento da WCA e Orientações da WCA. O conteúdo anterior de ambos os documentos foi junto no Regulamento da WCA para a versão de 17 de julho de 2025.
...
- 1c++) [ESCLARECIMENTO] Delegados da WCA podem participar na competição sem serem designados a servir a função de Delegado da WCA para a competição. "O Delegado da WCA" não se refere a eles a não ser que tenham sido apontados para uma responsabilidade relevante pelo Delegado da WCA designado para a competição (ver [Regra 1c+)](regulations:regulation:1c+)).
...
- 1l) Cada ronda de Frente a Frente deve ter um apresentador.
...
- 2b) Competidores com menos de 18 anos necessitam ter permissão do(s) seu(s) pai(s) ou responsável(is) para se inscrever e competir.
...
- 2d) O nome, país, sexo e resultados de um competidor na competição são considerados informações públicas. Todas as outras informações pessoais são consideradas confidenciais, e não podem ser fornecidas a entidades ou a terceiros sem o consentimento do competidor.
...
- 2e++) [ADIÇÃO] O Delegado da WCA deve também verificar o nome e data de nascimento mediante documentos ou fotos de documentos (Ex.: um passaporte) de todos os competidores principiantes na sua primeira competição.
    ...
    - 2e2) Competidores podem alterar o seu país em qualquer ponto entre competições (ver [Regra 2c2](regulations:regulation:2c2)), desde que tenha passado, pelo menos, um ano desde a alteração anterior.
        ...
        - 2e2b) Exceção: Se o competidor tiver adquirido uma nova no ano civil, poderá alterar o seu país para a sua nova cidadania antes ou na sua próxima competição.
- 2f) Competidores devem obedecer às regras do local da competição e comportar-se de maneira apropriada.
- 2g) Os competidores devem permanecer em silêncio quando estiverem na área de competição. É permitido conversar, mas deverá ser mantido num nível razoável e distante dos competidores que estiverem a competir naquele momento.
...
- 2i) Durante a inspeção ou resolução, os competidores podem usar objetos que não proporcionem uma vantagem injusta, a critério do Delegado da WCA. Penalidade por usar um objeto não permitido: desqualificação da tentativa (DNF). Exceção: se um objeto não permitido for usado, a tentativa atual e quaisquer tentativas concluídas não precisam ser desqualificadas se o competidor não tiver obtido uma vantagem injusta com o objeto, a critério do Delegado da WCA; no entanto, o competidor não deve ser autorizado a realizar mais tentativas com o objeto.
    - 2i1) Exemplos de objetos que devem ser permitidos:
        - 2i1a) Acessórios médicos/físicos usados pelo competidor (por exemplo, óculos, pulseira).
        - 2i1b) Tampões e protetores auriculares não eletrónicos, mas não auscultadores e auriculares eletrónicos (ver [Regra 2i2a](regulations:regulation:2i2a)).
        - 2i1c) Alimentos e bebidas.
        - 2i1d) Aquecedores de mãos eletrónicos ou não eletrónicos.
        - 2i1e) Câmaras, incluindo telemóveis utilizados como câmaras. Os monitores das câmaras devem estar em branco ou fora do campo de visão do competidor.
    - 2i2) Os seguintes objetos não devem ser permitidos durante uma tentativa:
        - 2i2a) Dispositivos capazes de reproduzir áudio para o competidor que não seja audível para o juiz (Ex.: auscultadores e auriculares eletrónicos). Isto inclui dispositivos relevantes que estejam desligados ou desconectados. Exceção: aparelhos médicos deste tipo (Ex.: aparelhos auditivos) podem ser permitidos se o competidor não tiver uma alternativa confortável.
        - 2i2b) Dispositivos usados para exibir informações através de um ecrã ativo visível para o competidor (Ex.: um telemóvel ou tablet).
        - 2i2c) Notas escritas ou outro material de referência que contém informações sobre como resolver um puzzle.
        - 2i2d) Outros puzzles.
        - 2i2e) Iluminação adicional.
- 2j) O Delegado da WCA pode desqualificar um competidor de uma tentativa e/ou evento específico.
    - 2j1) Se um competidor for desqualificado de um evento por alguma razão, este não tem direito a mais nenhuma tentativa nesse evento.
        - 2j1a) Se o competidor já começou, pelo menos, uma tentativa numa ronda antes de ser desqualificado da mesma, os resultados posteriores devem ser registados como DNF. Se o competidor ainda não começou nenhuma tentativa, nenhum resultado é registado (ver [Regra 9f5a](regulations:regulation:9f5a)).
    ...
    - 2j3) Tentativas específicas completadas podem ser desqualificadas dentro das circunstâncias descritas na [Regra 2k](regulations:regulation:2k), apenas se o incidente relevante tiver ocorrido durante a tentativa.
- 2k) Segundo critério do Delegado da WCA, um competidor pode ser desqualificado de algumas tentativas e/ou eventos específicos (um único evento, vários eventos, ou todos os eventos) se este:
    ...
    - 2k6) Não cumpre os requisitos do evento (Ex.: não saber como resolver o puzzle). Um competidor não deverá competir com a expetativa de um resultado DNF ou um mau resultado intencional.
...
- 2n) Os competidores podem disputar verbalmente uma decisão com o Delegado da WCA.
    ...
    - 2n3+) [ADIÇÃO] O competidor pode recorrer às decisões através do processo definido pela [Moção de Disputas](https://documents.worldcubeassociation.org/documents/motions/16.2025.1%20-%20Disputes.pdf).
...
- 2s+++) [EXEMPLO] Um competidor que não pode usar uma das suas mãos para começar o timer pode receber assistência do juiz para começar e parar o temporizador, ou um competidor que não pode ouvir pode receber os seus avisos de inspeção de maneira diferente.
    ...
    - 2s1+) [EXEMPLO] Exemplos de tais acomodações incluem: um competidor invisual usar uma segunda mão para sentir as peças em 3x3x3 Com Uma Mão ou usar um segundo puzzle com peças especiais durante a fase de memorização em 3x3x3 Vendado.
- 2u) Os competidores têm que estar presentes e preparados para competir quando são chamados para uma tentativa. Penalidade: desqualificação do evento.
    - 2u1) Exceção: um competidor que não estiver presente a tempo de uma tentativa individual marcada de um evento (Ex.: uma tentativa de resolução de 3x3x3 em Menos Movimentos, uma tentativa de resolução de 3x3x3 Vários Cubos Vendado) pode ser considerado ter desistido dessa tentativa (DNS), segundo critério do Delegado da WCA.
...
- 3a+++) [ESCLARECIMENTO] Competidores podem pedir puzzles de outros competidores de maneira privada, para usar em competição.
    ...
    - 3a4) Puzzles não podem ter componentes eletrónicas (Ex.: Bluetooth ou capacidades de Wi-Fi, motores, sensores, luzes).
- 3d) Os puzzles têm que ter partes coloridas, que definem o esquema de cores do puzzle e que são obrigatoriamente de um dos seguintes tipos: autocolantes coloridos, placas coloridas, plástico colorido ou cores pintadas/impressas. Todas as partes coloridas de um puzzle têm que ser feitas do mesmo material. Exceção: para Clock, os puzzles não têm partes coloridas.
    - 3d1) Para competidores com deficiência visual medicamente documentada, aplicam-se as seguintes exceções:
        - 3d1a) Competidores podem usar puzzles com texturas diferentes em faces diferentes. Cada face deve ter uma cor distinta, para ajudar no embaralhamento e ajuizamento.
        - 3d1b) Competidores daltónicos que não distingam o número necessário de cores podem usar partes coloridas com cores uniformes adicionais ou padrões, se forem explicitamente aprovadas de acordo com a [Regra 2s](regulations:regulation:2s). Cores uniformes adicionais ou padrões podem vir de autocolantes, ou serem desenhados.
        - 3d1b+) [ESCLARECIMENTO] Cores uniformes adicionais ou padrões não precisam de estar presentes em todas as faces, mas apenas as faces onde uma cor distinta não consegue ser distinguida. Peças não podem ter quaisquer especificidades (Ex.: texturas, irregularidades nos padrões) que distingam significativamente peças similares.
...
- 3h++) [EXEMPLO] Exemplos de melhorias incluem: novos movimentos são possíveis, movimentos normais são impossíveis, mais peças ou faces estão visíveis, cores na parte de trás do puzzle estão visíveis, movimentos são feitos automaticamente, ou os puzzles têm mais/diferentes estados resolvidos.
    ...
    - 3h2++) [ESCLARECIMENTO] Puzzle "sem autocolantes" que diferem significativamente da maioria dos puzzles "sem autocolantes" produzidos em massa são apenas permitidos a critério do Delegado da WCA.
        - 3h2a) Puzzles com partes transparentes que podem revelar razoavelmente mais informação sobre o estado do puzzle. Exceção: autocolante sobreposto ou um logo (ver [Regra 3l](regulations:regulation:3l)).
    ...
    - 3h4+) [ESCLARECIMENTO] Para Clock, modificações visuais que melhorem a habilidade de determinar a orientação do puzzle são permitidas, visto que designs tradicionais do puzzle já fornecem esta informação.
        - 3h4a) Modificações visuais (Ex.: capas de papel) são permitidas, a critério do Delegado da WCA. Qualquer modificação deve ter 12 marcadores de horas claros para cada face com relógios internos, com uma indicação distinta às 12 horas que corresponda ao puzzle original.
...
- 4b++) [LEMBRETE] Se o Delegado da WCA gerar quaisquer sequências de embaralhamento adicionais durante a competição, as sequências de embaralhamento devem ser guardadas.
    ...
    - 4b2++) [ADIÇÃO] Organizadores de competições devem assegurar que os embaralhadores, sequências de embaralhamento, e que puzzles embaralhados parcialmente/totalmente estão visualmente isolados dos competidores [ver Regra A2c](regulations:regulation:A2c). Por exemplo, os embaralhadores podem estar localizados atrás de uma parede, ou um divisor suficientemente alto (Ex.: um divisor de cartão colocado ao longo dos lados de uma mesa onde os embaralhadores estão sentados) podem ser utilizados de forma a que não seja possível ver os puzzles os embaralhadores aplicam as sequências de embaralhamento.
        ...
        - 4b2b) Competidores, oficiais e espetadores não devem fotografar ou gravar sequências de embaralhamento, a menos que tenham obtido permissão do Delegado da WCA. Isso inclui sequências de embaralhamento para grupos concluídos. Exceção: como o competidor recebe diretamente a sequência de embaralhamento para uma tentativa de 3x3x3 em Menos Movimentos, ele pode fotografá-la após submeter a sua tentativa.
...
- 5b) Se um defeito no puzzle ocorrer durante uma tentativa, o competidor pode escolher entre reparar o defeito e continuar a tentativa, ou pará-la.
    ...
    - 5b5++) [EXEMPLO] Exemplos de peças fisicamente separadas, que resultam num DNF: duas tampas de centro do 3x3x3, duas peças de centro de cubos maiores, uma peça de aresta do 3x3x3, uma peça de aresta do 4x4x4 ("wing"), qualquer combinação de duas peças em que ambas sejam coloridas.
        ...
        - 5b5f++) [EXEMPLO] Uma aresta ("wing") do 4x4x4 rodada em torno de si, é considerada como estando resolvida.
...
- 7f) Estação de resolução:
    - 7f1) Definições:
        - 7f1a) Temporizador de resolução em velocidade "speedsolving": Um temporizador aprovado da [Lista de Temporizadores Aprovados](https://drive.google.com/file/d/1UizYZOY4v-t7YnKcXas0hHzekX-NGuhW/view).
        - 7f1b) Tapete: O tapete onde o temporizador de resolução em velocidade "speedsolving" é colocado.
        - 7f1b+) [ESCLARECIMENTO] Um tapete de tamanho normal deve ter dimensões mínimas de 30 cm (da esquerda para a direita) por 25 cm (de frente para trás).
        - 7f1c) Temporizador: o temporizador de resolução em velocidade "speedsolving", ou um cronómetro (para tentativas mais longas).
        - 7f1d) Superfície: A superfície plana na qual o temporizador de resolução em velocidade "speedsolving" foi colocado. O tapete é considerado parte da Superfície. O temporizador não é considerado parte da Superfície.
    - 7f2) O temporizador de resolução em velocidade "speedsolving" deve ser anexado ao Tapete e posicionado na Superfície, com o temporizador na parte do Tapete mais próxima do competidor.
    - 7f3) A equipa de organização deve modificar os temporizadores de resolução em velocidade "speedsolving" para serem mais robustos contra incidentes comuns, por exemplo fazendo com que os botões sejam mais difíceis de pressionar por acidente (Ex.: anexando Anéis-O à volta dos botões) e segurando as pilhas mais firmemente (Ex.: estufando o compartimento das pilhas).
- 7h) Se os competidores não permanecerem na mesma estação de resolução para o decorrer de todas as suas tentativas numa ronda, a área de competição tem de ter uma ou mais Áreas de Espera para Competidores. Exceção: rondas com tentativas individuais marcadas.
...
- 9b++) [ADIÇÃO] Outros eventos para além dos especificados na [Regra 9b](regulations:regulation:9b) podem ser realizados durante a competição, mas serão considerados não oficiais e não serão incluídos nos resultados oficiais da competição.
    ...
    - 9b3) 3x3x3 Vendado.
        - 9b3a) O formato de rondas completas para este evento: "Melhor de 5".
        - 9b3b) Para este evento, a WCA também reconhece rankings e recordes para "Média de 5", fora do formato da competição. A estatística de "Média de 5" não afeta o ranking do competidor numa ronda de "Melhor de 5", sendo baseada no melhor resultado (ver [Regra 9f6](regulations:regulation:9f6) e [Regra 9f12](regulations:regulation:9f12)).
    ...
    - 9b6) 4x4x4 Vendado e 5x5x5 Vendado.
        - 9b6a) O formato de rondas completas para estes eventos: "Melhor de 3".
        - 9b6b) A estatística de "Média de 3" não afeta o ranking do competidor numa ronda de "Melhor de 3", sendo baseada no melhor resultado (ver [Regra 9f6](regulations:regulation:9f6) e [Regra 9f12](regulations:regulation:9f12)).
    - 9b7) O formato Frente a Frente (ver [Artigo I](regulations:article:I)) está disponível da seguinte forma:
        - 9b7a) O formato Frente a Frente está disponível para os seguintes eventos: Cubo 3x3x3, Cubo 4x4x4, 3x3x3 Vendado, e 3x3x3 Com uma Mão.
        - 9b7b) O formato Frente a Frente deverá apenas ser usado numa ronda final de um evento.
- 9f) Os resultados de uma ronda são medidos da seguinte forma:
    - 9f1) Todos os resultados cronometrados abaixo de 10 minutos são arredondados por defeito ao centésimo de segundo. Todas as médias calculadas abaixo de 10 minutos são arredondadas ao centésimo de segundo mais próximo.
    - 9f2) Todos os tempos cronometrados de 10 ou mais minutos, bem como os resultados de 3x3x3 Vários Cubos Vendado são medidos e truncados para segundos. Todas as médias cronometradas acima de 10 minutos são calculadas e arredondadas para o segundo mais próximo (Ex.: X.49 torna-se X, X.50 se torna X+1).
    ...
    - 9f6) Nos formatos "Melhor de X", cada competidor tem direito a X tentativas. O melhor resultado dessas tentativas conta para a posição do competidor na ronda. Exceção: para Rondas Duplas (ver [Regra 9v4](regulations:regulation:9v4)), o melhor resultado de qualquer uma das rondas determina o ranking do competidor.
    - 9f7) Nos formatos "Melhor de X", um DNF ou DNS é o pior resultado possível.
    - 9f8) No formato "Média de 5", os competidores têm direito a 5 tentativas. Dessas 5, a melhor e a pior são removidas, e a média aritmética das 3 resoluções restantes conta para a posição do competidor na ronda. Exceção: para Rondas Duplas (ver [Regra 9v4](regulations:regulation:9v4)), a melhor média de qualquer uma das rondas determina o ranking do competidor.
    - 9f9) No formato "Média de 5", um DNF ou DNS é permitido como o pior resultado do competidor na ronda. Se um competidor tem mais de um DNF e/ou DNS na ronda, a sua média nessa ronda será DNF.
    - 9f10) No formato "Média de 3", os competidores têm direito a 3 tentativas. A média aritmética das 3 conta para a posição do competidor na ronda. Exceção: para Rondas Duplas (ver [Regra 9v4](regulations:regulation:9v4)), a melhor média de qualquer uma das rondas determina o ranking do competidor.
    - 9f11) No formato "Média de 3", se um competidor tiver um resultado DNF ou DNS, a sua média nessa ronda será DNF.
    - 9f12) Nos formatos "Melhor de X", os seguintes critérios são usados para comparar resultados:
    ...
    - 9f13) Nos formatos "Média de 3" e "Média de 5", os resultados são ordenados conforme as médias alcançadas pelos competidores, em que "melhor" é o menor tempo registado.
    - 9f14) Nos formatos "Média de 3" e "Média de 5", se dois ou mais competidores obtiverem médias idênticas, os resultados são ordenados com base na melhor resolução por competidor, em que "melhor" é definido como o menor tempo.
    - 9f15) Competidores que obtiverem o mesmo resultado numa ronda ficam na mesma posição.
    - 9f16) Para rondas Frente a Frente:
        - 9f16a) Os competidores têm direito a tentativas conforme o descrito no [Artigo I](regulations:article:I).
        - 9f16b) O vencedor da Partida Final fica em primeiro lugar. O perdedor da Partida Final fica em segundo lugar. O vencedor da Partida pelo Terceiro Lugar fica em terceiro lugar. O perdedor da Partida pelo Terceiro Lugar fica em quarto lugar. Todos os outros competidores são classificados com base na fase mais alta alcançada, com o seu melhor resultado individual na ronda a servir como desempate.
        - 9f16b+) [EXEMPLO] Os quatro competidores eliminados na Fase das Quartas de Final têm os melhores tempos individuais de 5.00 segundos, 5.10 segundos, 5.20 segundos e 5.30 segundos e estão classificados em quinto, sexto, sétimo e oitavo lugares, respetivamente.
- 9g) Uma Ronda de Tempo de Corte é uma ronda com uma fase de tempo de corte no formato "Melhor de X" e um tempo de corte requerido (Ex.: "Melhor de 2" com um tempo de corte requerido de estritamente melhor que 2 minutos). Se o competidor satisfizer o tempo de corte em pelo menos uma das tentativas na fase de tempo de corte, ele é elegível para as tentativas restantes. Tentativas da fase de tempo de corte contam para o formato de ronda completa.
- 9i) Os resultados de competições oficiais da WCA têm de ser listados nos rankings mundiais da WCA.
    - 9i1) A WCA reconhece os seguintes tipos de recordes regionais: recordes nacionais, continentais e mundiais.
        - 9i1a) Um recorde regional é reconhecido quando um novo resultado é igual, ou melhor do que o recorde existente. Exceção: ver [Regra 9i2](regulations:regulation:9i2).
    - 9i2) Todos os resultados de uma ronda são considerados como tendo acontecido na última data do calendário daquela ronda, baseado no horário local do Local da competição. Se um recorde regional for alcançado várias vezes na mesma data do calendário, somente o melhor resultado é reconhecido como tendo quebrado aquele recorde regional. Para competições com vários locais físicos (por exemplo, "competições simultâneas de 3x3x3 em Menos Movimentos"), a data do calendário é a data mais tardia em qualquer local da competição.
...
- 9l) Cada ronda deve ser terminada antes que qualquer ronda seguinte desse mesmo evento inicie. As seguintes exceções são aplicadas:
...
- 9o) Para efeitos de contagem do número de rondas por evento:
    - 9o1) Rondas de Tempo de Corte contam como uma ronda.
    - 9o2) Rondas Duplas contam como duas rondas.
    - 9o3) Rondas Frente a Frente contam como uma ronda.
- 9p) Se um evento tem várias rondas, então:
    - 9p1) Pelo menos 25% dos competidores têm que ser eliminados entre rondas consecutivas do mesmo evento. Exceção: Rondas Duplas (ver [Regra 9v5](regulations:regulation:9v5)).
    - 9p2) Os competidores que avançam para a próxima ronda devem ser determinados por ranking (melhores X competidores) ou por resultado (todos os competidores com um resultado melhor que X) na ronda anterior.
        - 9p2a) Para cada ronda, o formato, tempo limite, requisitos de corte, e condições de avanço têm de ser anunciados antes da ronda começar, e não devem ser alterados depois do seu começo. Alterações têm de ser feitas a critério do Delegado da WCA, que deve considerar cuidadosamente a justiça da mudança.
        - 9p2a+) [ADIÇÃO] Não deve ser adicionada uma ronda a um evento após o início da ronda final desse evento, a menos que todos os competidores que alcançaram lugares no pódio na ronda final existente concordem com a alteração.
        - 9p2a++) [LEMBRETE] Não deve ser adicionada uma ronda após uma ronda Frente a Frente, uma vez que essa ronda Frente a Frente deixaria de ser a ronda final de um evento (ver [Regra 9b7b](regulations:regulation:9b7b)).
        - 9p2b) Exceção: para competições designadas como Campeonato Nacional ou Campeonato Continental, a equipa de organização pode alterar as condições de avanço para reservar vagas para competidores que representam a região relevante. Um máximo de 8 vagas ou 50% das vagas na ronda seguinte, o que for menor, pode ser reservado dessa forma. Para uma ronda Frente a Frente, 100% das vagas podem ser reservadas dessa forma. Para uma ronda com vagas reservadas, os competidores que avançam da ronda anterior são um número reservado dos melhores competidores que representam a região relevante, seguidos pelos melhores competidores restantes que representam qualquer região.
        - 9p2b+) [ADIÇÃO] Se não existirem competidores suficientes da região relevante para preencher os espaços reservados, eles devem ser preenchidos com competidores que representem qualquer região.
        ...
        - 9p2b+++) [RECOMENDAÇÃO] Qualquer uso de espaços reservados deve ser claramente anunciado antes da competição.
    - 9p3) Se um competidor classificado se retirar de uma ronda, pode ser substituído pelo competidor melhor não classificado na ronda anterior.
...
- 9t++) [ADIÇÃO] Se a alteração de resultados acontecer durante a competição, esta Regra deve também ser aplicada. Nesse caso, as Regras [9t1](regulations:regulation:9t1), [9t2](regulations:regulation:9t2) e [9t3](regulations:regulation:9t3) devem também ser seguidas, a critério do Delegado da WCA.
    ...
    - 9t3+) [EXEMPLO] Supõe-se que um competidor A obtenha uma média de 10.00 e o competidor B obtém uma média de 10.05 na primeira ronda de um evento, de maneira que o competidor B obtém uma média de 9.95 (e devesse ter avançado para a Ronda Final em vez do A), o competidor A mantém os seus resultados da Ronda Final.
    - 9t4) Esta regra não se aplica entre as fases de uma ronda Frente a Frente.
    - 9t5) Exceção: os resultados de rondas consecutivas não são eliminados se, na sequência de uma alteração de resultado para DNS após a competição, em conformidade com o Regulamento 11i1, o competidor já não tivesse passado à ronda seguinte.
...
- 9u+) [ADIÇÃO] Para competições com vários locais físicos (Ex.: "Competições Simultâneas de 3x3x3 em Menos Movimentos"), todos os requerimentos devem ser cumpridos em todos os locais para se considerar a competição como acabada.
    ...
    - 9u2+) [RECOMENDAÇÃO] O Delegado da WCA deve anunciar o fim da competição (Ex.: antes da cerimónia de entrega de prémios).
        ...
        - 9u2b) O fim do último dia do calendário da competição é alcançado (ver [Regra 9i2](regulations:regulation:9i2)).
        - 9u2b+) [ADIÇÃO] A data de calendário do fim da competição é determinada pela hora local do local onde a competição se realiza.
- 9v) Duas rondas consecutivas de um evento podem ser designadas como Rondas Duplas.
    - 9v1) As Rondas Duplas podem incluir apenas as duas primeiras rondas de um evento.
    - 9v2) As Rondas Duplas não devem incluir a ronda final de um Campeonato Nacional, Campeonato Continental ou Campeonato Mundial.
    - 9v3) As rondas duplas devem ter o mesmo formato, tempo de corte e limite de tempo.
    - 9v4) A classificação do competidor nas Rondas Duplas é baseada no melhor resultado de qualquer uma das rondas.
        - 9v4a) Os resultados de ambas as rondas são registados e são elegíveis para o ranking mundial da WCA (ver [Regra 9i](regulations:regulation:9i)) e recordes regionais (ver [Regra 9i1](regulations:regulation:9i1)).
    - 9v5) Nenhum competidor é eliminado entre as rondas durante as Rondas Duplas.
        - 9v5a) Os competidores sem resultados na primeira ronda ou com resultados apenas de DNF e/ou DNS na primeira ronda são elegíveis para avançar para a segunda ronda.
...
- 10e) Um puzzle está resolvido quando todas as partes coloridas forem reconstruídas e todas as partes estão alinhadas, nos limites especificados abaixo:
    ...
    - 10e1+) [ESCLARECIMENTO] Para Square-1, devido à sua mudança de forma, a métrica para desalinhamentos definida na [Regra 10f4](regulations:regulation:10f4) difere da métrica para notação, usada pelo programa de embaralhamento e definida na [Regra 12c4](regulations:regulation:12c4).
...
- 10i) O estado resolvido do Clock é alcançado quando todos os dezoito relógios interiores apontam para as 12 horas.
    - 10i1) Relógios interiores que não apontam claramente para um marcador das horas são considerados com estando a apontar para o marcador das horas mais próximo.
    - 10i2) O estado resolvido do Clock não é afetado por tampas de pinos soltas, ou quase soltas.
...
- 11e+++++++) [RECOMENDAÇÃO] Se uma tentativa extra for dada para uma ronda após uma ronda subsequente já ter terminado, e a tentativa extra leva o competidor a avançar para a próxima ronda, o competidor não deve competir na ronda subsequente, a critério do Delegado da WCA.
    ...
    - 11e1+) [LEMBRETE] A tentativa extra deve ser embaralhada usando uma sequência de embaralhamento não modificada gerada pelo programa oficial de embaralhamento (ver [Regra 4b](regulations:regulation:4b), [Regra 4b+](regulations:regulation:4b+)).
    ...
    - 11e2++) [EXEMPLO] Suponha-se que um competidor tem 5 tentativas regularmente numeradas, e a 2.ª leva a tentativas extra. O competidor deve realizar tentativas extra até haver uma tentativa extra válida para repor a 2.ª. Suponha-se que mais tarde outra tentativa leva a tentativas extra, o competidor deve proceder de forma similar à 2.ª.
        - 11e2a) Se as tentativas forem concluídas fora de ordem, os resultados devem ser registados com base na ordem das sequências de embaralhamento, e não na ordem em que as tentativas foram realizadas.
...
- 11f) Decisões sobre um incidente podem ser auxiliadas pela análise de vídeos, fotografias ou provas em áudio, a critério do Delegado da WCA.
    ...
    - 11f1+) [RECOMENDAÇÃO] O Comité do Regulamento da WCA deve ser consultado se análise em câmara-lenta ou frame-por-frame for requerida.
        ...
        - 11f1d) Para apoiar a remoção de qualquer penalidade originalmente aplicada pelo juiz ou pelo Delegado da WCA (ver [Regra 11f2a](regulations:regulation:11f2a)).
...
- 11i) Se um puzzle de um competidor é descoberto com estando embaralhado incorretamente após terem concluído a resolução, as seguintes regras aplicam-se:
    - 11i1) Nos casos seguintes, uma tentativa extra deve ser dada para repor a tentativa afetada. Se nenhuma tentativa extra é atribuída, o resultado será considerado como DNS:
...
- 11l) Para rodadas Frente a Frente, a resolução de qualquer incidente é considerada final quando a partida é concluída, para fins de determinar quem ganha o ponto. Exceção: batota ou fraude.
    - 11l1) O resultado de uma tentativa pode ser alterado posteriormente, mas isso não altera o vencedor do ponto.
...
- 12d) Notação para o Megaminx (notação somente para embaralhamento):
    ...
    - 12d2) Os outros movimentos são aplicados mantendo-se 3 peças fixas na parte superior-esquerda do puzzle:
        ...
        - 12d2d) Movimento de 144 graus no sentido anti-horário de todo o puzzle exceto pela camada das três peças na parte superior-esquerda: R-- (camadas verticais), D-- (camadas horizontais).
...
- 12h) Notação para Skewb:
    - 12h1) O puzzle é orientado com três faces completamente visíveis, com a face do topo para cima.
...
- A1) Resoluções em velocidade "speed solving" devem seguir o procedimento seguinte.
    ...
    - A1a+) [ESCLARECIMENTO] Se ambos os limites forem aplicados, o tempo limite por tentativa não pode ser maior que o tempo limite cumulativo.
        ...
        - A1a2++++++) [ESCLARECIMENTO] Se um tempo limite cumulativo se aplicar a uma combinação de rondas para diferentes eventos, a ordem em que as tentativas são feitas é a ordem em que essas tentativas contam para o tempo limite cumulativo. Exceção: ver [Regra 11e2a](regulations:regulation:11e2a). A ordem em que as tentativas são realizadas deve ser anotada na folha de resultados.
    ...
    - A1b++) [ADIÇÃO] A equipa de organização pode fornecer ao competidor um cronómetro não oficial para ver o tempo decorrido (iniciado juntamente com o cronómetro principal), caso em que o competidor não está autorizado a tocar no cronómetro oficial. Exceção: ver [Regra A6a1](regulations:regulation:A6a1).
        - A1b1) Um temporizador de resolução em velocidade "speedsolving" deve ser usado em complemento com um cronómetro. Para eventos sem inspeção, onde o competidor é esperado que exceda 10 minutos, o uso de um temporizador de resolução em velocidade "speedsolving" é opcional.
        - A1b2) Se um tempo medido pelo temporizador de resolução em velocidade "speedsolving" estiver disponível, esse é o tempo original registado. Caso contrário (Ex.: o temporizador de resolução em velocidade "speedsolving" não funcionou corretamente, ultrapassou os 10 minutos ou não foi sequer utilizado), o tempo do cronómetro é o tempo original registado.
...
- A2) Embaralhamento:
    - A2a) Quando chamado para uma ronda, o competidor entrega o seu puzzle, no estado resolvido, para o embaralhador.
        ...
        - A2a3+) [LEMBRETE] Os competidores não devem ser autorizados a ver as sequências de embaralhamento do seu próprio grupo, mesmo após terem concluído todas as suas tentativas, a menos que tenham obtido autorização do Delegado da WCA (ver [Regra 4b2+](regulations:regulation:4b2+)).
    ...
    - A2c) Após o embaralhador começar a embaralhar o puzzle, o competidor não pode ver o puzzle até que se inicie a fase de inspeção.
        - A2c1) O embaralhador coloca uma cobertura sobre o puzzle embaralhado, de forma a que seja impossível a qualquer competidor ou espetador ver qualquer parte do puzzles. A cobertura deve permanecer sobre o puzzle até ao início da tentativa.
        ...
        - A2c2) Enquanto estiver a competir, o competidor não deve estar ativamente a tentar a olhar para outro competidor a completar uma tentativa oficial. Se um competidor vir outro competidor resolver um embaralhamento que o mesmo ainda não recebeu, a tentativa correspondente é registada como DNF. Exceção: esta penalidade não se aplica a competidores em rondas Frente a Frente (ver [Artigo I](regulations:article:I)).
    ...
    - A2d) Ao receber um puzzle do embaralhador, o juiz deve inspecioná-lo rapidamente para assegurar que foi embaralhado. Em caso de dúvida, o juiz contacta o embaralhador, que faz uma verificação detalhada.
        - A2d1) O embaralhador ou juiz autorizado deve verificar o puzzle embaralhado, e assinar a folha de resultados para confirmar que aplicou a corretamente numerada sequência de embaralhamento e verificar que está igual à imagem (ver [Regra 4g](regulations:regulation:4g)). Exceção: para o Cubo 5x5x5, Cubo 6x6x6, o Cubo 7x7x7, e Megaminx o embaralhador pode assinar para confirmar que o puzzle está suficientemente embaralhado (ver [Regra 4g1](regulations:regulation:4g1)). Assinaturas de embaralhadores devem ser consistentes no decorrer da competição e devem identificar o embaralhador.
        ...
        - A2d1+++) [LEMBRETE] Embora o Delegado da WCA possa permitir que várias tentativas individuais com assinaturas de embaralhamento em falta sejam contadas, deve garantir que as assinaturas de embaralhamento em falta não se tornem comuns.
...
- A3) Inspeção:
    - A3a) O competidor pode inspecionar o puzzle no início de cada resolução.
        - A3a1) O competidor tem um tempo estrito de menos de 15 segundos para inspecionar o puzzle e iniciar a resolução.
    ...
    - A3c) O competidor pode pegar no puzzle durante a inspeção.
        ...
        - A3c5) Para Square-1, o competidor não deve ser penalizado por nenhum movimento acidental realizado entre os limites da [Regra 10f](regulations:regulation:10f). Se o puzzle estiver num estado em que um movimento / não pode ser aplicado sem um movimento (X, Y) prévio, o competidor pode realizar um movimento (X, Y) para alcançar o estado mais próximo onde um movimento / pode ser aplicado (ver [Regra 12c](regulations:regulation:12c)).
        - A3c5+) [LEMBRETE] Como um estado de puzzle onde um movimento / não pode ser aplicado não é um estado de embaralhamento correto (ver [Regra 4b3d](regulations:regulation:4b3d)), uma tentativa extra deve ser atribuída se a [Regra 11i1](regulations:regulation:11i1) se aplicar.
    - A3d) No final da inspeção, o competidor coloca o puzzle sobre o tapete em qualquer orientação. O puzzle deve estar totalmente sobre o tapete e não pode estar em parte ou totalmente apoiado no temporizador de resolução em velocidade "speedsolving". Penalidade: penalidade de tempo (+2 segundos).
...
- A6) Finalizando a resolução:
    - A6a) O competidor finaliza a resolução largando o puzzle e parando o temporizador de resolução em velocidade "speedsolving" corretamente. Se um cronómetro estiver a ser usado, o juiz para-o assim que o competidor fizer o referido.
        - A6a1) Se o juiz não estiver imediatamente disponível para parar o cronómetro quando um cronómetro está em uso, o competidor pode parar o cronómetro.
    - A6b) É responsabilidade do competidor parar o temporizador de resolução em velocidade "speedsolving" corretamente.
        - A6b1) Se o temporizador de resolução em velocidade "speedsolving" parar antes do fim da resolução e mostrar um tempo abaixo de 0.06 segundos, a resolução é substituída por uma resolução adicional. O competidor perde o direito à tentativa extra se o Delegado da WCA determinar que o cronómetro foi parado deliberadamente, ou como resultado de uma interação com o temporizador numa maneira não usual (Ex.: fazer contacto mínimo com o temporizador, não levantar as mãos claramente para fora do temporizador).
        - A6b1+) [EXPLICAÇÃO] O valor arbitrário de 0.06 segundos foi escolhido para acomodar preocupações sobre o mau funcionamento do temporizador de resolução em velocidade "speedsolving".
        - A6b2) Se o temporizador de resolução em velocidade "speedsolving" parar antes do fim da resolução e mostrar um tempo de 0.06 segundos ou maior, a resolução é desqualificada (DNF). Exceção: O Delegado da WCA pode atribuir uma tentativa extra se este acreditar que o temporizador pode não ter funcionado corretamente e o competidor não parou o temporizador deliberadamente.
    - A6c) O competidor deve soltar totalmente o puzzle antes de parar o temporizador de resolução em velocidade "speedsolving". Penalidade: penalidade de tempo (+2 segundos). Exceção: Se nenhum movimento ou alteração no alinhamento foi aplicado após parar o temporizador e antes de largar o puzzle, a tentativa pode ser desqualificada (DNF), a critério do juiz.
    - A6d) O competidor deve parar o temporizador de resolução em velocidade "speedsolving" usando ambas as mãos, colocadas planas sobre os sensores e com as palmas para baixo. Penalidade: penalidade de tempo (+2 segundos).
    - A6e) O competidor não pode tocar, realizar um movimento, ou fazer uma alteração no alinhamento do, puzzle até que o juiz o tenha determinado se o puzzle está resolvido (ver [Regra A6g](regulations:regulation:A6g)).
...
- A7) Registo de resultados:
    ...
    - A7c+) [ADIÇÃO] Se um resultado assinado por um competidor for considerado incompleto ou ilegível, deve ser interpretado da pior forma razoável (por exemplo, "1:05" será considerado 1:05.99, "25.X3" será considerado 25,73 se X puder ser um 1 ou um 7). Dado que o temporizador de resolução em velocidade "speedsolving" pode exibir um tempo de X:0Y.ss como X:Y.ss, um dígito das dezenas em falta deve ser considerado mais provável do que um dígito das unidades em falta (por exemplo, "1:2.27" será considerado 1:02.27). O juiz que assinou um resultado ambíguo pode ser solicitado a esclarecê-lo, a critério do responsável pelo registador de resultados.
        ...
        - A7c3) Se um competidor assinar (ou marcar) uma tentativa após esta se ter iniciado, mas antes que o juiz tenha terminado de registar o resultado, a tentativa vai ser considerada inacabada (DNF). Exceção: se o juiz registar o resultado incorretamente (por exemplo, não registar nenhum resultado ou um resultado incompleto e, em seguida, passar a folha de resultados ao competidor) e o resultado correto for esclarecido posteriormente, a penalidade poderá ser retirada, a critério do Delegado da WCA.
        - A7c4) O competidor não deve assinar antes que o juiz tenha registado e assinado a tentativa. O competidor é ultimamente responsável por assegurar que ele próprio e o juiz assinaram a tentativa. Se uma tentativa é descoberta como tendo faltada uma ou ambas as assinaturas após o juiz ter entregue a folha de resultados ao registador de resultados (ver [Regra A7f](regulations:regulation:A7f)), esta vai ser considerada inacabada (DNF).
        ...
        - A7c7) O competidor não deve marcar a folha de resultados noutro local para além da área designada para assinar.
        - A7c8) Se uma assinatura foi esquecida devido à inexperiência do competidor, esta pode ser assinada a qualquer momento, a critério do Delegado da WCA. Se já não é possível que a folha de registo seja assinada pessoalmente, um atestado pelo respetivo indivíduo em conforme o resultado foi corretamente registado pode ser aceite como assinatura, a critério do Delegado da WCA.
    ...
    - A7g+) [EXEMPLO] Exemplo de incidentes que podem levar à atribuição de uma tentativa extra a um competidor inexperiente: começar ou terminar o temporizador de forma imprópria, ir para além do tempo de inspeção devido a uma incorreta interpretação de como começar a resolução, ou outras penalidades por erros procedimentais.
    - A7g++) [ESCLARECIMENTO] Penalidades individuais não podem ser descartadas para novos competidores. Uma tentativa extra completa deve ser atribuída.
    - A7g+++) [RECOMENDAÇÃO] O Delegado da WCA deve ter um critério muito mais forte quando atribui mais do que uma tentativa extra ao mesmo competidor, especialmente se for pelo mesmo tipo de incidente.
...
- B2) Início da resolução:
    ...
    - B2d+) [ADIÇÃO] Por padrão, o competidor começa a resolução na primeira vez que inicia o temporizador após o juiz indicar que está pronto (ver [Regra B2a](regulations:regulation:B2a)). Se quiser verificar se o temporizador está a funcionar corretamente, deve (pedir e) receber confirmação do juiz cada vez que iniciar/reiniciar o temporizador durante esta fase. Penalidade por iniciar e reiniciar um temporizador sem confirmação do juiz: desqualificação da tentativa (DNF).
        - B2d1) O competidor retira a cobertura do puzzle após ter iniciado o temporizador Stackmat.
        - B2d2) Se um cronómetro estiver em uso como complemento ao temporizador de resolução em velocidade "speedsolving", o juiz começa o cronómetro assim que o competidor comece a resolução.
    ...
    - B2f+) [ESCLARECIMENTO] Como o competidor começa a resolver levantando a cobertura, as penalidades por iniciar o temporizador e por tocar na cobertura ao começar a tentativa não se aplicam (ver [Regra B2b](regulations:regulation:B2b) e [Regra B2c](regulations:regulation:B2c)).
- B3) Fase de memorização:
    ...
    - B3d) Se partes do puzzle não estiverem totalmente alinhadas, então o competidor pode alinhar as faces, desde que os desalinhamentos estejam entre os limites da [Regra 10f](regulations:regulation:10f) (ver [Regra A3c2](regulations:regulation:A3c2))
- B4) Fase vendada:
...
- E2) Procedimento para Resolução em Menos Movimentos:
    - E2a) O juiz distribui uma sequência embaralhamento e um papel a todos os competidores. De seguida, o juiz inicia o cronómetro e dá o sinal de "VÃO".
        ...
        - E2a2) Antes do início da tentativa, o competidor não deve revelar a sequência de embaralhamento. Penalidade: desqualificação da tentativa (DNF).
    ...
    - E2b+) [ESCLARECIMENTO] Um competidor pode optar por interromper uma tentativa antes do tempo, entregando uma solução antes do limite de tempo.
        - E2b1) O juiz deve dizer "FALTAM 5 MINUTOS" quando o tempo atingir 55 minutos, e deve dizer "PAREM" quando o tempo atingir 60 minutos.
        - E2b2) Se um competidor entrar numa tentativa que já está em progresso (ver [Regra E6](regulations:regulation:E6)), o seu tempo limite é o tempo que resta (ele deve acabar quando os outros competidores acabarem o seu tempo limite de 60 minutos).
    - E2c) Nos 60 minutos, cada competidor deve entregar ao juiz uma solução escrita de forma legível, com informação para identificar a tentativa. A solução do competidor é considerada correta se começando com o puzzle resolvido e aplicando a sequência de embaralhamento seguida da solução resulta num puzzle resolvido.
    ...
    - E2e) A solução do competidor não pode ser diretamente retirada de alguma parte da sequência de embaralhamento. Penalidade: desqualificação da tentativa (DNF), a critério do Delegado da WCA.
...
- E3) O competidor pode usar os seguintes objetos durante a resolução. Penalidade por usar objetos não autorizados: desqualificação da tentativa (DNF). Exceção: se o competidor não obtiver qualquer vantagem ao usar objetos não autorizados, o resultado poderá ser mantido, a critério do Delegado da WCA.
    ...
    - E3e) Outros objetos que não dão uma vantagem injusta, a critério do Delegado da WCA (ver [Regra 2i](regulations:regulation:2i)).
    - E3f) Ferramentas para remover marca (fornecido pelo competidor), tais como fluído corretor, corretor em fita, ou borrachas.
- E4) O Delegado da WCA pode escolher publicar as soluções (Ex.: foto das folhas de resultados ou transcrições das soluções).
- E5) O competidor não pode comunicar com ninguém para além do juiz e do Delegado da WCA. Esta comunicação deve ser sobre o Regulamento da WCA e o competidor não pode receber nenhuma assistência em relação à sua solução. Penalidade: desqualificação da tentativa (DNF). Exceção: se o competidor não obtiver vantagem ao comunicar-se com qualquer pessoa que não seja o Delegado da WCA ou o juiz, o resultado poderá ser mantido, a critério do Delegado da WCA.
- E6) Um competidor pode começar uma tentativa de 3x3x3 em Menos Movimentos que já está em progresso, a critério do Delegado da WCA. Exceção: um competidor não pode começar uma tentativa em progresso nos seguintes casos:
    - E6a) Um competidor já acabou a sua tentativa (ver [Regra E2b+](regulations:regulation:E2b+).
    - E6b) A tentativa existe em vários locais físicos (" Competições de 3x3x3 em Menos Movimentos Simultâneas").
    - E6c) Existe risco de informação sobre o embaralhamento já pode ter chegado ao competidor que deseja começar a tentativa.


## <article-H><multiple-blindfolded><multipleblindfoldedsolving> Artigo H: Resolução de Vários Cubos Vendado

- H1) É seguido o procedimento comum da Resolução Vendada, como descrito no [Artigo B](regulations:article:B) (Resolução Vendada). Regras adicionais sobrepõem-se aos procedimentos correspondentes do [Artigo B](regulations:article:B) são descritas em seguida.
- H1+) [ADIÇÃO] Se um puzzle com um embaralhamento duplicado for encontrado durante uma tentativa, o puzzle pode ser reembaralhado usando uma sequência de embaralhamento diferente, a critério do Delegado da WCA.
    - H1a) Antes da resolução, o competidor deve comunicar à equipa de organização o número de puzzles (pelo menos 2) que quer tentar resolver vendado.
        - H1a1) O competidor não pode mudar o número de puzzles privado após o ter submetido à equipa de organização.
    ...
    - H1b) Se um competidor estiver a tentar resolver menos de 6 puzzles, é-lhe atribuído um limite de tempo de 10 minutos, multiplicado pelo número de puzzles na tentativa, caso contrário, o tempo limite é de 60 minutos. Exceção: um competidor que chegar atrasado poderá competir com um tempo limite reduzido, a critério do Delegado da WCA. A tentativa desse competidor não deve ser embaralhada usando as mesmas sequências de embaralhamento dos competidores que já completaram a sua tentativa (ver [Regra H1f](regulations:regulation:H1f).
    ...
    - H1e) Qualquer penalidade de desqualificação durante uma tentativa aplica-se a toda a tentativa (DNF). Exceção: para penalidades relacionadas com puzzles individuais (Ex.: fazer um movimento durante a memorização, usar um puzzle ilegal), esses puzzles podem ser considerados como não resolvidos no final da tentativa, em vez de desqualificar toda a tentativa, a critério do Delegado da WCA.
    - H1f) Se estiver previsto que os competidores comecem em momentos significativamente diferentes, de modo que haja o risco de que as informações sobre os embaralhamentos possam ter sido divulgadas aos competidores, as tentativas que começarem mais tarde deverão usar sequências de embaralhamento diferentes.
...
## <article-I><headtohead><headtoheadsolving> Artigo I: Resolução Frente a Frente
...
- I2) Estrutura da ronda:
    - I2a) Uma ronda Frente a Frente é estruturada como um torneio de eliminação simples, compreendendo várias fases:
        - I2a1) Para rondas com 4 vagas: Fase de Semifinal e Fase Final.
        - I2a2) Para rondas com 8 vagas: Fase dos Quartos de Final, Fase de Semifinal e Fase Final.
        - I2a3) Para rondas com 12 vagas: Fase de Playoff, Fase dos Quartos de Final, Fase de Semifinal e Fase Final.
        - I2a4) Para rondas com 16 vagas: Fase dos Oitavos de Final, Fase dos Quartos de Final, Fase de Semifinal e Fase Final.
    - I2b) Cada fase compreende várias partidas entre 2 competidores:
        - I2b1) Fase Final: 2 Partidas: a Partida Final e a Partida pelo Terceiro Lugar.
...
- I3) Estrutura da partida:
    - I3a) Cada partida é composta por vários sets. O vencedor da partida é o primeiro competidor a ganhar X sets (onde X é 1, 2 ou 3).
        ...
        - I3a2) Para as fases seguintes, X deve ser igual ou superior ao da fase anterior.
    - I3b) Cada set é composto por vários pontos. O vencedor de um set é o primeiro competidor a ganhar 3 pontos.
